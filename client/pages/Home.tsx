    ...
    <div className="space-y-12">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm/6 font-medium text-white/90">
                <GraduationCap className="h-4 w-4" /> Welcome to EduAdmin Institute
              </div>
              <h1 className="mt-2 text-3xl font-bold leading-tight sm:text-5xl">
                Learn skills. Build your career.
              </h1>
              <p className="mt-2 max-w-2xl text-white/85">
                Job‑ready programs designed with mentors and real projects. Explore courses, apply online, and get guidance at every step.
              </p>
            ...
            <div className="rounded-xl bg-white/10 px-4 py-3 text-sm backdrop-blur">
              ...
              <div className="mt-1 flex items-center gap-2 text-white/80"><CalendarDays className="h-4 w-4" /> New courses added weekly</div>
            </div>
          </div>
          <div className="mt-6 flex flex-wrap items-center gap-2 text-sm">
            <Link to="/courses" className="rounded-full border px-3 py-1.5 hover:bg-white/10">All</Link>
            <Link to="/courses/featured" className="rounded-full border px-3 py-1.5 hover:bg-white/10">Featured</Link>
      ...
      <section className="space-y-4">
        <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
          <h2 className="text-xl font-semibold flex items-center gap-2"><Compass className="h-5 w-5 text-primary" /> Explore by Category</h2>
        ...
        <div className="flex flex-wrap gap-2">
          {categories.map((c) => (
            <Button asChild key={c} variant="secondary" className="rounded-full">
